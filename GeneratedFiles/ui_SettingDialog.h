...
public:
    ...
    {
        SettingDialog->setWindowTitle(QApplication::translate("SettingDialog", "Setting Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("SettingDialog", "Default Grammar:", Q_NULLPTR));
        pushButtonDefaultGrammar->setText(QApplication::translate("SettingDialog", "...", Q_NULLPTR));
